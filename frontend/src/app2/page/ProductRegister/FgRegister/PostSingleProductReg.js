...
//     mat_ColumnDefs: { status_check_id: 1 },
...
//   console.log("columnDefsObj", columnDefsObj);
//   console.log("fetchResult?.productRegisterOption?.data ", fetchResult?.productRegisterOption?.data );
...
//     [
//         ...new Map(resultProductRegItemOption.map((item) => [item.component, item])).values()
//     ]
//     .filter((item) => item.component && !/productOption/i.test(item.component))
//     .map((item) => ({
...
//     };
//   }, [m_mat_data, status_check_id_data]);
...
// export default PostSingleProductReg;
