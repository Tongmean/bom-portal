...
const ProductReg = () => {
            ...
            cellRenderer: (params) => (
                <Space>
                    ...
                    <Button
                        ...
                        onClick={()=>{
                            navigate(`/app2/product-register/FG-Register/putSingle/${params.data.product_reg_id}`);
                        }}
                    >
                        Edit
                    </Button>
    ...
    //     navigate(
    //         `/app2/product-register/semifg-Register/singleArray?ids=${ids.join(",")}`
    //     );
    // };
            ...
            />
              <Space>
                <Button
                    ...
                    type="primary"
                    style={{ backgroundColor: '#fcb830', borderColor: '#efbb54' }}
                    onClick= {()=> navigate("/app2/product-register/FG-Register/postSingle")}
                    disabled = {!canAction()}
                >
                    เพิ่มรายการ
                </Button>
