...
const ProcessOrderTooling = () => {
    ...
    const { data, loading, error } = useFetch(
        // `${baseURL}/app2/cert_ificate`
        `${baseURL}/app2/process_tooling`,
                ...
                <Space>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            navigate(`/app2/process/routing-order-tooling/putSingle/${params.data.process_routing_tooling_id}`);
                        }}
                    >
                        Edit
                    </Button>
        ...
        <div>
            ...
            <Space style={{ marginBottom: 16, marginTop: 16 }}>
                <Button
                    ...
                    onClick={() => navigate("/app2/process/routing-order-tooling/postSingle")}
                    disabled={!canAction()}
                >
                    เพิ่มรายการ
                </Button>
...
export default ProcessOrderTooling;