...
const PutSinglesdpackaging = () => {
  ...
  const endpoints = useMemo(
    () => ({
        currentHeader: `${baseURL}/app2/sdpackaging/${id}`,
        currentDetail: `${baseURL}/app2/sdpackaging/detail/${id}`,
  ...
  const handleUpdate = async (payload) => {
    ...
    try {
      const result = await mutate({
        url: `${baseURL}/app2/sdpackaging/putSingle`,
        method: "POST",
        data: payload,
      });
...
export default PutSinglesdpackaging;